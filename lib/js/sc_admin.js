(function ($) {
	...
	var build = '<tr class="sce_tr"><td class="sce_card"><textarea class="multibox sce_card-body" id="newmb'+rnd_strg+'" name="'+id+'_sceeditor'+rnd_strg+'"></textarea></td>';
	build+= '<input class="multibox order" type="hidden" name="'+id+'_order'+rnd_strg+'" value="'+numItems+'"></tr>';
